function [weight] = stack2weight(stack)
...
%
% [weight, netconfig] = stack2weight(stack)
%
...
% If using a gpu pass inWeight as your gpu datatype
% Setup the compressed weight vector
weight = [];
...
for d = 1:numel(stack)
    ...
    % is okay
    weight = [weight ; stack{d}.W(:) ; stack{d}.b(:) ];
